...
public class DequeStudentTest {
    ...
    /*
    Begin custom cases! This is my first time writing tests,
    so please let me know if I'm missing anything!
    */

    @Test(timeout = TIMEOUT)
    public void testArrayAddAndRemoveFirstSingleElement() {
        String[] expected = new String[ArrayDeque.INITIAL_CAPACITY];
        array.addFirst("0a");
        expected[10] = "0a";
        assertEquals("0a", array.getFirst());
    ...
    @Test(timeout = TIMEOUT)
    public void testLinkedAddAndRemoveFirstSingleElement() {
        linked.addFirst("0a");
        assertEquals("0a", linked.getFirst());
    ...
    @Test(timeout = TIMEOUT)
    public void testArrayAddAndRemoveLastSingleElement() {
        String[] expected = new String[ArrayDeque.INITIAL_CAPACITY];
        array.addLast("0a");
        expected[0] = "0a";
        assertEquals("0a", array.getFirst());
    ...
    @Test(timeout = TIMEOUT)
    public void testLinkedAddAndRemoveLastSingleElement() {
        linked.addLast("0a");
        assertEquals("0a", linked.getFirst());
        assertEquals("0a", linked.getLast());
        assertEquals(linked.getHead(), linked.getTail());
    ...
    public void testArrayIllegalArgumentException1() {
        array.addFirst(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testArrayIllegalArgumentException2() {
        array.addLast(null);
    }

    @Test(expected = NoSuchElementException.class)
    public void testArrayNoSuchElementException1() {
        array.removeFirst();
    }

    @Test(expected = NoSuchElementException.class)
    public void testArrayNoSuchElementException2() {
        array.removeLast();
    }

    @Test(expected = NoSuchElementException.class)
    public void testArrayNoSuchElementException3() {
        array.getFirst();
    }

    @Test(expected = NoSuchElementException.class)
    public void testArrayNoSuchElementException4() {
        array.getLast();
    }

    @Test(expected = IllegalArgumentException.class)
    public void testLinkedIllegalArgumentException1() {
        linked.addFirst(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testLinkedIllegalArgumentException2() {
        linked.addLast(null);
    }

    @Test(expected = NoSuchElementException.class)
    public void testLinkedNoSuchElementException1() {
        linked.removeFirst();
    }

    @Test(expected = NoSuchElementException.class)
    public void testLinkedNoSuchElementException2() {
        linked.removeLast();
    }

    @Test(expected = NoSuchElementException.class)
    public void testLinkedNoSuchElementException3() {
        linked.getFirst();
    }

    @Test(expected = NoSuchElementException.class)
    public void testLinkedNoSuchElementException4() {
        linked.getLast();
    }
}